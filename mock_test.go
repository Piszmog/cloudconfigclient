...
//)
//
//// mockCloudClient is the mocked object that implements httpClient
...
//func NewConfigClient(clients ...cloudconfigclient.httpClient) cloudconfigclient.ConfigClient {
